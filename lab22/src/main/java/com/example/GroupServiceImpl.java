...
public class GroupServiceImpl implements GroupService {
    ...
    public ResponseEntity<?> addGroup(String groupName) {
        ...
        emailService.sendEmail("Mihalkevitc.23V@yandex.ru", "Успешное создание группы", "Была создана группа " + groupName);
        logger.info("Email about {} {} successfully send!", groupName);
        return ResponseEntity.ok("Group " + groupName + " created successfully and email send!");
    }
